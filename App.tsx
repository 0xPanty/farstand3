                                ...
                                {stats && statDetails && (
                                    <div className="mb-4 pb-3 border-b border-dotted border-[#999]">
                                        ...
                                        <div className="space-y-1.5 text-[11px] text-[#333]">
                                            <div className="flex items-center"><span className="w-20 text-[#666]">POWER</span><span className="text-[14px] font-bold w-5">{stats.power}</span><span className="flex-1 border-b border-dotted border-[#ccc] mx-2"></span><span className="text-[9px] text-[#888]">{statDetails.power}</span></div>
                                            <div className="flex items-center"><span className="w-20 text-[#666]">SPEED</span><span className="text-[14px] font-bold w-5">{stats.speed}</span><span className="flex-1 border-b border-dotted border-[#ccc] mx-2"></span><span className="text-[9px] text-[#888]">{statDetails.speed}</span></div>
                                            <div className="flex items-center"><span className="w-20 text-[#666]">RANGE</span><span className="text-[14px] font-bold w-5">{stats.range}</span><span className="flex-1 border-b border-dotted border-[#ccc] mx-2"></span><span className="text-[9px] text-[#888]">{statDetails.range}</span></div>
                                            <div className="flex items-center"><span className="w-20 text-[#666]">DURABILITY</span><span className="text-[14px] font-bold w-5">{stats.durability}</span><span className="flex-1 border-b border-dotted border-[#ccc] mx-2"></span><span className="text-[9px] text-[#888]">{statDetails.durability}</span></div>
                                            <div className="flex items-center"><span className="w-20 text-[#666]">PRECISION</span><span className="text-[14px] font-bold w-5">{stats.precision}</span><span className="flex-1 border-b border-dotted border-[#ccc] mx-2"></span><span className="text-[9px] text-[#888]">{statDetails.precision}</span></div>
                                            <div className="flex items-center"><span className="w-20 text-[#666]">POTENTIAL</span><span className="text-[14px] font-bold w-5">{stats.potential}</span><span className="flex-1 border-b border-dotted border-[#ccc] mx-2"></span><span className="text-[9px] text-[#888]">{statDetails.potential}</span></div>
                                        </div>
                                    </div>
                                )}
